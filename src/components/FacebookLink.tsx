...
//   Android - intent:// obal nad fb://page/<id>. Chrome pri chybajucej appke sam
//             prejde na browser_fallback_url, takze netreba vlastny timeout ani
//             hrozi chybova stranka ERR_UNKNOWN_URL_SCHEME.
